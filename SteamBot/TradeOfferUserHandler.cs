    ...
    public class TradeOfferUserHandler : UserHandler
    {
        ...
        public override void OnNewTradeOffer(TradeOffer offer)
        {
            ...
            if (IsAdmin)
            {
                ...
                Log.Info("Me han pedido " + myItems.Count + " ,de mi inventario.");
                Log.Info("A cambio de " +  theirItems.Count + " ,de su inventario.");
                ...
                if (DummyValidation(myItems, theirItems))
                {
                    ...
                    if (acceptResp.Accepted)
                    {
                        ...
                        Log.Success("Oferta de intercambio aceptada con exito : Trade ID: " + acceptResp.TradeId);
                    }
                }
                else
                {
